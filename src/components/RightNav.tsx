...
export const RightNav: React.FC<RightNavProps> = ({
  ...
  const handleOptimizeDatabase = async () => {
    ...
    try {
      ...
      alert(`Database optimized! Saved ${savedMB}MB of space.`);
    } catch (error) {
      ...
      <div className="p-4 border-t border-gray-200 flex-shrink-0 space-y-2">
        ...
        {lastSaveTime && (
          <div className="text-xs text-gray-500 text-center py-1">
            Last save: {lastSaveTime.toFixed(0)}ms
          </div>
        )}
        ...
        <button
          ...
          className="w-full px-4 py-2 bg-orange-500 text-white rounded-lg shadow-lg hover:bg-orange-600 transition-colors flex items-center justify-center disabled:opacity-50 disabled:cursor-not-allowed"
        >
